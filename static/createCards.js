  ...
  <div class="row g-0">
    ...
    <div class="col-lg-8 d-flex flex-column">
      ...
      <div class="card-footer d-grid gap-2 d-lg-flex mt-auto">
        ...
        <a id="link" href="recipe-page.html" class="bbb btn btn-full-recipe">Full recipe</a>
...
.then((data) => {
  ...
  $('.btn').on('click', function() {
    ...
    let buttonId = $(this).attr('id'); // Get the id of the button
    var buttonIndex = $('.bbb').index(this);
    localStorage.setItem('recipeObj', JSON.stringify(recipes[buttonIndex])); // Save the id to local storage
  });
